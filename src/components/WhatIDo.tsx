        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>MERN Stack</h3>
              <h4>I build full-stack web applications.</h4>
              <p>
                I create dynamic and responsive web applications using the MERN stack. From intuitive user interfaces to robust backends, I deliver end-to-end solutions that meet modern web standards.
              </p>
